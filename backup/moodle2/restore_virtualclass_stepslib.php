...
/**
 * Define all the restore steps that will be used by the restore_virtualclass_activity_task
 */

/**
 * Structure step to restore one virtualclass activity
 */
class restore_virtualclass_activity_structure_step extends restore_activity_structure_step {
    ...
    protected function process_virtualclass($data) {
        global $DB;
