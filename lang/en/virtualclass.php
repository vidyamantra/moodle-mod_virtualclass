...
/**
 * English strings for virtualclass
 *
...
$string['silencedetect'] = 'Silence Detector';
//$string['silencedetectdisable'] = 'Silence detection disable';
//$string['silencedetectenable'] = 'Silence detection enable';
