...
if ($r == 's') {
    ...
    // $statusicon = html_writer::tag('img', '', array('src' => $iconurl, 'class' => 'icon icon-post', 'alt' => get_string('status')));.
                $pressingimg = $whiteboard_path . "images/speakerpressing.png";
    ...
    $pressonceimg = $whiteboard_path . "images/speakerpressonce.png";
    ...
    echo html_writer::start_tag('div', array('id' => 'silenceDetect', 'class' => 'audioTool'));
        $silencedetect = $whiteboard_path . "images/silencedetectdisable.png";
